...
abstract class BaseFilterAdapter<T : BaseFilterAdapter.Searchable,
        V : BaseViewHolder<T>>(private val originItems: MutableList<T>) : RecyclerView.Adapter<V>(),
    Filterable {
        ...
        return object : Filter() {
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (constraint == null || constraint.isEmpty()) {
                    ...
                    val searchResults =
                        items.filter {
                            it.getSearchCriteria().lowercase(Locale.getDefault())
                                .contains(
